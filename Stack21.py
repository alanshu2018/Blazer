...
class Stack1Conf(object):
    ...
    test = [
        ...
        out_dir + 'cv_test_avg_pred.Feat@stack10_Learner@reg_lgb_native.csv',
        #out_dir + 'cv_test_avg_pred.Feat@stack11_Learner@reg_fmftrl.csv',
        out_dir + 'cv_test_avg_pred.Feat@stack13_Learner@reg_lgb_native.csv',
        out_dir + 'cv_test_avg_pred.Feat@stack8_Learner@reg_lgb_native.csv',
    ]
    train = [
