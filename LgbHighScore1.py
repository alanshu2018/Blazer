...
def DO(frm,to,fileno):
    ...
    #test_df.to_csv("../newdata/test_v28.csv", index=False)
    #train_df[:len_train].to_csv("../newdata/train_v28.csv", index=False)
    ...
    lgb.plot_importance(bst, ax=ax, max_num_features=len(predictors))
    plt.title("Light GBM Feature Importance")
    #plt.savefig('test_%d.png'%(fileno))
