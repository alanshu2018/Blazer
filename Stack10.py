...
class Stack1Conf(object):
    ...
    #Target in data
    target_file = "../newdata/train_v26_7_9.csv"
    target = 'click_id'
    weight = 'weight'
...
params_dict = {
    ...
    'nthread': 8,
    'num_leaves': 100,
    'reg_alpha': 1.0946486265106712e-05,
    'subsample_for_bin': 331062,
    'colsample_bytree': 0.17818380002331338,
    'scale_pos_weight': 5.5418599247136102,
    'learning_rate': 0.79292960015400038,
    'min_child_weight': 4,
    'max_depth': 167,
    'num_boost_round':5000,
    #'n_estimators': 67,
    'subsample': 0.68539440194028223,
    'reg_lambda': 1000.0,
    'subsample_freq': 0,
    'max_bin': 10000,
